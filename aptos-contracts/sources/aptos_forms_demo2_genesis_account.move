...
module aptos_forms_demo2::aptos_forms_demo2_genesis_account {
    use aptos_forms_demo2::aptos_forms_demo2_resource_account as resource_account;
    use aptos_framework::account;
    use aptos_framework::event;
    use std::error;
    use std::signer;

    friend aptos_forms_demo2::aptos_forms_demo2_start_page;
    ...
    public fun assert_genesis_account(account: &signer) {
        assert!(signer::address_of(account) == @aptos_forms_demo2, error::invalid_argument(ENotGenesisAccount));
    }

    public(friend) fun resource_account_signer(): signer {
        resource_account::resource_account_signer(@aptos_forms_demo2)
    }
    ...
    public fun resource_account_address(): address {
        let res_account = resource_account::resource_account_signer(@aptos_forms_demo2);
